...
func setupButtons() {
    let buttonsConfig = [
        ("State of health", "Etat.png"),
        ("Teperature", "Tempr).png"),
        ("Pain", "Pain.png"),
        ("Liquid", "Liqui.png"),
        ("Diarrhea", "Diarr.png"),
        ("Rash", "Erup.png"),
        ("Symptoms", "Sad.png"),
        ("Warning signs", "SignA.png"),
        ("Feeling confi...", "Sur.png"),
        ("Contact with...", "Cons.png"),
        ("Medication", "Medoc.png"),
        ("Measures", "Mes.png"),
        ("Note", "Notes2).png")
    ]
...
//END OF SCROLL VIEW CODE
    ...
    func setupSymptomsView() {
        ...
        topLabel.text = "Are there signs of dehydration?"
        ...
        NSLayoutConstraint.activate([
            ...
            myImage.widthAnchor.constraint(equalToConstant: 30),
                   ...
                   let symptoms = ["No", "Yes, dry mucous membranes (=no tears when crying a...", "Yes, the skin is dry and loose", "Yes, child looks very tired", "Yes, the eye sockets appear sunken", "Yes, significantly fewer wet diapers than normal", "Yes, the fontanelle is sunken"]
