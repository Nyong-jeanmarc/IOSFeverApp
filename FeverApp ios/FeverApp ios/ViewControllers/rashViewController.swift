...
import UIKit
class rashViewController: UIViewController{
...
//END OF SCROLL VIEW CODE
        ...
        func setupSymptomsView() {
            ...
            topLabel.text = "Does <name> have a rash?"
            ...
            NSLayoutConstraint.activate([
                ...
                myImage.widthAnchor.constraint(equalToConstant: 30),
                       ...
                       let symptoms = ["No", "yes, the redness can be pushed away", "yes, the redness cannot be pushed away"]
