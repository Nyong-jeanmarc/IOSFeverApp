...
//END OF SCROLL VIEW CODE
        ...
        func setupSymptomsView() {
            ...
            topLabel.text = "Dose <name> have any symptoms?"
            ...
            NSLayoutConstraint.activate([
                ...
                myImage.widthAnchor.constraint(equalToConstant: 30),
                       ...
                       let symptoms = ["No", "Cough", "Constrained breathing", "Freezing / chills", "Fatigue, exhaustion", "Sense of smell/taste disturbed", "Mucus (ear, nose and throat)", "Tonsillitis", "Joint swelling", "Teething", "Other symptoms"]
