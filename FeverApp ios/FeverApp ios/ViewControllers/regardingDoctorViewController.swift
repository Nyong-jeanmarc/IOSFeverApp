//
//  regardingDoctorViewController.swift
//  FeverApp ios
//
//  Created by NEW on 03/09/2024.
//
import UIKit
class regardingDoctorViewController: UIViewController{
...
//END OF SCROLL VIEW CODE
        ...
        func setupSymptomsView() {
            ...
            topLabel.text = "Have you had any medical contact regarding <name>?"
            ...
            NSLayoutConstraint.activate([
                ...
                myImage.widthAnchor.constraint(equalToConstant: 30),
                       ...
                       let symptoms = ["No", "Yes, we spoke with our doctor", "Yes, we spoke with another doctor (substitute)", "Yes, with the emergency services"]
