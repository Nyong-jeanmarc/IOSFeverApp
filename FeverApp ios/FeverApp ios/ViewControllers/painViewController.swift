...
//END OF SCROLL VIEW CODE
    ...
    func setupSymptomsView() {
        ...
        topLabel.text = "Does <name> have any Pain?"
        ...
        NSLayoutConstraint.activate([
            ...
            myImage.widthAnchor.constraint(equalToConstant: 30),
                   ...
                   let symptoms = ["No", "Yes, in the limbs", "Yes, in the head","Yes, in the neck","Yes, in the ears","Yes, in the stomach","Yes,somewhere else"]
