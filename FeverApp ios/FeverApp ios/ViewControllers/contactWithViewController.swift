        ...
        func setupSymptomsView() {
            ...
            NSLayoutConstraint.activate([
                ...
                myImage.widthAnchor.constraint(equalToConstant: 30),
                       ...
                       let warningSigns = ["No", "Yes we spoke to our doctor", "Yes, we spoke with another doctor(substitute)", "Yes, with the emergency services"]
