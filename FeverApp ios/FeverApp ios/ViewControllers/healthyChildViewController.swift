//
//  healthyChildViewController.swift
//  FeverApp ios
//
...
import UIKit
class healthyChildViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let Label = UILabel()
        Label.text = TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.HEADING.63")
        ...
        let imageView = UIImageView(image: UIImage(named: "SMILE-CHILD"))
    ...
    """
        ...
        NSLayoutConstraint.activate([
            ...
            containerView.heightAnchor.constraint(equalToConstant: 280) // Keep the height of mainView
        ])
    }
