//
//  DoctorQuestionViewController.swift
//  FeverApp ios
//
...
class DoctorQuestionViewController: UIViewController{
    ...
    @IBAction func nextBtnTapped(_ sender: UIButton) {
        // Instantiate the view controller from the storyboard
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyboard.instantiateViewController(withIdentifier: "InfoLibraryWhyDoseTheBodyRaisTheTemperatureViewController")
    ...
    override func viewDidLoad() {
        ...
        let Label = UILabel()
        Label.text = TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.HEADING.8")
        ...
        let imageView = UIImageView(image: UIImage(named: "biggestdoct"))
...
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.99"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.100"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.101"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.102"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.103"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.104"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.105"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.106"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.107"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.108"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.109"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.110"))\n
•\(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.111"))\n
"""
