//
//  feverWithoutAccompanyingViewController.swift
//  FeverApp ios
//
//  Created by Bar Bie  on 14/09/2024.
//

import UIKit

class feverWithoutAccompanyingSymptomsViewContoller:UIViewController{
    ...
    @IBAction func nextBtnTapped(_ sender: UIButton) {
        ...
        override func viewDidLoad() {
            ...
            let Label = UILabel()
            Label.text = TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.HEADING.31")
            ...
            let imageView = UIImageView(image: UIImage(named: "Rectangle45"))
            ...
            textView.text = """
                               ...
                               \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.257"))\n
                               \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.258"))\n
                             \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.259"))\n
