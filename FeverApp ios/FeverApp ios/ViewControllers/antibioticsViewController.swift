//
//  antibioticsViewController.swift
//  FeverApp ios
//
...
class antibioticsViewController:UIViewController{
    ...
    @IBAction func nextBtnTapped(_ sender: UIButton) {
        // Instantiate the view controller from the storyboard
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyboard.instantiateViewController(withIdentifier: "healthyChildViewController")
        ...
        override func viewDidLoad() {
            ...
            let Label = UILabel()
            Label.text = TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.HEADING.62")
            ...
            let imageView = UIImageView(image: UIImage(named: "Rectangle48"))
            ...
            textView.text = """
                      ...
                      \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.700"))\n
                      
                      \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.701").replacingOccurrences(of: "<.*?>", with: "", options: .regularExpression))\n
                      
                      \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.702").replacingOccurrences(of: "<.*?>", with: "", options: .regularExpression))\n
                      
                      \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.703"))\n
                      
                      \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.704"))\n
                      
                       \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.705"))\n
                       • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.706"))\n
                       • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.707"))\n
                       • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.708"))\n
                       • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.709"))\n
                      
                       \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.710"))\n
                      
                       \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.711"))\n
                      
                       \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.712"))\n
                       \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.713"))\n
                       \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.700").replacingOccurrences(of: "<.*?>", with: "", options: .regularExpression))\n
                      
                       • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.715").replacingOccurrences(of: "<.*?>", with: "", options: .regularExpression))\n
                       • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.716").replacingOccurrences(of: "<.*?>", with: "", options: .regularExpression))\n
