//
//  certificationEmployerViewController.swift
//  FeverApp ios
//
...
import UIKit
class certificationEmployerViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let Label = UILabel()
        Label.text = TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.HEADING.7")
        ...
        let imageView = UIImageView(image: UIImage(named: "biggesttest"))
        ...
        textView.text = """
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.85")))\n\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.86")))\n\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.87")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.88")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.89")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.90")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.91")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.92")))\n\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.93")))\n\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.94")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.95")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.96")))\n
\(removeHTMLTags(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.97")))\n
"""
       
       

        _ = ["How long can employees stay at home with their sick child?", "Unpaid",  "is younger than twelve", "a pediatrician's certificate:", "Married couples",  "ten child sick days per year for each parent for each child", "More than two children", "maximum of 25 days per year per parent", "Single parents",   "20 days per child",  "50 days", "regulated most explicity", "the full salary", "up to four days special leave", "", "up to four days special leave", "Where does the employee get his money from - from the employer or the health insurance?",  "individual regulations", "How do employess get child sickness benefit (Kinderkrankengeld)?",  "claim child sickness benefit", "70 percent of the gross income or a maximum of 90 percent of the net income", "Privately insured employees do not have the right to the so-called child  sickness  benefit."  ]
