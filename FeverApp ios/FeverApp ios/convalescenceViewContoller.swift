...
class convalescenceViewContoller:UIViewController{
    ...
    @IBAction func nextBtnTapped(_ sender: UIButton) {
        ...
        override func viewDidLoad() {
            ...
            let Label = UILabel()
            Label.text =  TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.HEADING.64")
            ...
            let imageView = UIImageView(image: UIImage(named: "Rectangle. 20"))
            ...
            textView.text = """
                        *    \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.718"))\n
                        * \(TranslationsViewModel.shared .getInfoLibraryTranslation(key:  "INFOS.TEXT.719"))\n
                        • \(TranslationsViewModel.shared  .getInfoLibraryTranslation(key:   "INFOS.TEXT.720"))\n
                        • \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.721"))\n
                      
                      \(TranslationsViewModel.shared.getInfoLibraryTranslation(key: "INFOS.TEXT.722"))\n
                      ...
                      NSLayoutConstraint.activate([
                          ...
                          newView.heightAnchor.constraint(equalToConstant: 40) // Height of newView
                      ])
                      ...
                      NSLayoutConstraint.activate([
                          ...
                          containerView.heightAnchor.constraint(greaterThanOrEqualToConstant: 560) // Keep the height of mainView
                      ])
                  }
